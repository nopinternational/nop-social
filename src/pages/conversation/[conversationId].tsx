...
function Chat({conversationId}:{conversationId:string}) {
  ...
  <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-[5rem]">CHAT:</h1>
      <div id="messages" className="bg-white h-96  flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
